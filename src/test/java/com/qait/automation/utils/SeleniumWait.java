...
public class SeleniumWait{
    ...
    public boolean waitForElementAttributeToChange(WebElement element,String attribute, String value) {
      
    	return wait.until(ExpectedConditions.attributeContains(element, attribute, value));
    	 }
    
    public boolean waitForElementTextToChange(WebElement element,String value) {
       
     	 // 	return wait.until(ExpectedConditions.textToBePresentInElement(element, value))==true;
	...
	public void waitforNoOfWndows(int n) {
